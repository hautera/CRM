...
from .models import Customer, Address, Ticket
...
class TicketSerializer(serializers.HyperlinkedModelSerializer):
	primary_contact = serializers.PrimaryKeyRelatedField(many=False, read_only=False, queryset=Customer.objects.all())
	class Meta:
		model = Ticket
		fields = ('number', 'title', 'device', 'status', 'primary_contact', )
